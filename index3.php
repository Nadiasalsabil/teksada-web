...
<nav class="navbar navbar-default">
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      ...
      <li><a href="index3.php?halaman=form"><font color="white">Form Penyiar |</font></a></li>
       <li class="dropdown">
      <a class="dropdown-toggle" data-toggle="dropdown" href="" style="background:black;"><font color="white">Data Penyiar<span class="caret"></span>&nbsp;|</font></a>
      <ul class="dropdown-menu" style="background:black;">
              <li><a href="index3.php?halaman=biodata" style="color:white;">Biodata Penyiar</a></li>
